...
import com.example.pradhyumna.quiztrivia.QuizContract.*;
...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        Questions q1 = new Questions("WHICH IS THE INNERMOST PLANET IN OUR SOLAR SYSTEM?", "MERCURY", "VENUS", "EARTH", 1);
        addQuestion(q1);
